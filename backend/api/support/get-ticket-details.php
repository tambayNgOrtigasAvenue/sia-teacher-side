...
try {
    ...
    // Get ticket details
    $result = $controller->getTicketDetails($ticketId, $userId);

    // Set appropriate HTTP status code
    if ($result['success']) {
        http_response_code(200);
    } else if (isset($result['error_code']) && $result['error_code'] === 'NOT_FOUND') {
    ...
    error_log("Error in get-ticket-details.php: " . $e->getMessage());
